# Aging TTS
This repository collects all the documents and programs for the implementation of the text-to-speech system I developed as part of my **Thesis Project** for the **MSc Voice Technology** at **Rijksuniversiteit Groningen**. The full thesis can be found [here](https://campus-fryslan.studenttheses.ub.rug.nl/469/1/MAS5298873AVanni.pdf).

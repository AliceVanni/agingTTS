...
from utils.dataset import select_utterances_from_cv, rename_speaker_id, create_dataset, count_speaker_per_group, age_group_redefinition, select_balanced_utterances, get_audio_folder_duration
...
new_age_group_file = age_group_redefinition('selected_validated_sp_renamed.txt')
...
# and age groups
balanced_dataset_file = select_balanced_utterances(new_age_group_file, 'CV_')
